...
action_label="Update"
prompt_msg="A new update is available. Do you want todownload and install it? [y/N]: "
else
...
echo -e "  ${CYAN}2) Direct scriptinstallation (/usr/local/bin/uraam)${NC}"
...
printf "%b\n" "${GREEN}[✓] URAAMhas been uninstalled.${NC}"
read -rp "Press Enter to return to menu..."
}
